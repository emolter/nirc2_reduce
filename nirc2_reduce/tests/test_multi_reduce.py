...
def test_MultiBxy3(datadir, rawdir, reddir, flatdir):
    ...
    obs = multi_reduce.MultiBxy3(rawdir)
    ...
    stack_test = fits.open(os.path.join(reddir, '2017-07-25_Neptune_stacked_nophot_Hclear.fits'))[0].data
    ...
    flat_test = fits.open(os.path.join(flatdir, '2017-07-25_flat_master_h.fits'))[0].data
